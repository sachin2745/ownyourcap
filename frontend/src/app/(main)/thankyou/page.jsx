                ...
                <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto ">
                    ...
                    {/* <div className="main-box border  border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full font-Jost">
                        ...
                        paymentData.map((order, index) => (
                            <div>
                                <div key={order._id} className="flex flex-col  lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
                                    <div className="data">
                                ...
                                <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                                    ...
                                    <p className="font-semibold text-lg text-white py-6">
                                        Total Price: <span className="text-sky-500"> ₹{order.details.amount/100}/-</span>
                                    </p>
                                </div>
                            </div>
                        ))}
